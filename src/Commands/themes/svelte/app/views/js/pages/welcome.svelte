<script>
    ...
    function tick(i = 0, char = 0) {
        const line = lines[i];
        if (char <= line.length) {
            typed = line.slice(0, char);
            timeoutId = setTimeout(() => tick(i, char + 1), char === line.length ? 2200 : 28);
        } else {
            const nextI = (i + 1) % lines.length;
            timeoutId = setTimeout(() => tick(nextI, 0), 400);
        }
    }
...
<div class="min-h-screen bg-neutral-50 font-sans text-sm text-neutral-950 antialiased dark:bg-neutral-950 dark:text-neutral-50">
    <div class="mx-auto flex min-h-screen w-full max-w-[1120px] flex-col px-6">
        <header class="flex flex-col items-start justify-between gap-4 py-5 sm:flex-row sm:items-center">
            <a href="https://leafphp.dev"
                ...
                aria-label="Leaf PHP">
                <img src="https://leafphp.dev/logo-circle.png" alt="" class="h-7 w-7">
                <span>Leaf MVC</span>
                <span
            ...
            <nav class="flex flex-wrap gap-1" aria-label="Useful Leaf links">
                <a href="https://github.com/leafsphp/leaf" target="_blank" rel="noreferrer"
                    class="flex items-center gap-2 rounded-lg px-3 py-2 text-[13px] font-medium text-neutral-600 transition hover:bg-black/5 hover:text-neutral-950 dark:text-neutral-400 dark:hover:bg-white/5 dark:hover:text-neutral-50">
                ...
                <a href="https://leafphp.dev/docs/" target="_blank" rel="noreferrer"
                ...
                <a href="https://leafphp.dev/support" target="_blank" rel="noreferrer"
        ...
        <main class="flex flex-1 flex-col gap-12 pb-16 pt-1">
            <section
                ...
                <div>
                    ...
                    <div class="mt-6 flex flex-wrap gap-2">
                        <a href="https://leafphp.dev/docs/intro/first-app" target="_blank" rel="noreferrer"
                        ...
                        <a href="https://leafphp.dev/docs/mvc/" target="_blank" rel="noreferrer"
                ...
                <div class="flex flex-col overflow-hidden rounded-2xl border border-neutral-500/10 font-mono text-xs shadow-md dark:border-neutral-700/10 dark:shadow-black/40 p-5 bg-neutral-900 text-neutral-100"
                    ...
                    <div class="grid gap-2.5 p-4 leading-relaxed">
                        ...
                        <div class="ml-3 grid gap-2 rounded-lg border border-neutral-800 bg-neutral-950/80 p-3">
                        ...
                        <div class="flex min-h-[1.6em] flex-wrap items-center gap-2 text-neutral-400">
                            ...
                            <span class="text-neutral-400">{typed}</span>
            ...
            <section aria-labelledby="overview">
                ...
                <p class="mb-5 max-w-xl text-[15px] leading-relaxed text-neutral-600 dark:text-neutral-400">
                    ...
                    Edit files in <code
                        class="font-mono text-[13px] text-neutral-950 dark:text-neutral-200">app/views/js/pages/welcome.svelte</code>, run
